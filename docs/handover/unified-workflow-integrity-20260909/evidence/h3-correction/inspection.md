...
| rendered inspection PNG | `a7a97b0b22c0309f9b2fc938a02ffb4ddaae484a51e0b2c1178f3824b899b0c4` | non-empty and inspectable; regenerated from the exact exported graph |

The source layout is absent, so fresh auto-placement is through the normal owner; the resulting evidence is readable and inspectable. All 20 exported node `properties.vibecomfy_uid` values are present and unique,
