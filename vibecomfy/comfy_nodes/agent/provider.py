...
def _compact_batch_system_prompt(
    *,
    ...
    return (
        ...
        "Preservation priority: treat existing nodes and branches as user-owned context. "
        "Prefer the smallest add/rewire change unless the request calls for cleanup or removal. "
        "When the user says to keep a chain intact, weigh its existing nodes, fields, and "
